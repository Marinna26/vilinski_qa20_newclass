        ...
        public class TeamCreation extends TestBase {
            ...
            public Iterator<Object[]> teamsPositive() throws IOException {
                ...
                BufferedReader reader = new BufferedReader(new FileReader(new File("src/test/resources/Teams_positive.csv")));
                String line = reader.readLine();

                while (line!= null) {
                    String[] split = line.split(",");
                    list.add(new Object[]{new Team().withTeamName(split[0]).withTeamDescription(split[1])});
